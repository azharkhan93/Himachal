...
$(document).ready(function() {
  ...
  $('#staticContactForm input, #staticContactForm textarea').on('focus click input keydown keyup change', function() {
    isFormBeingUsed = true;
  });

  // Reset form usage flag when user stops interacting
  $('#staticContactForm input, #staticContactForm textarea').on('blur', function() {
    setTimeout(function() {
